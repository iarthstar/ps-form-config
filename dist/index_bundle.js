...
(function($PS) {
  ...
  var encodeInputField = new Foreign_Generic_Class.Encode(function (v) {
      if (v instanceof Text) {
          return Foreign_Generic_Class.encode(encodeTextField)(v.value0);
      };
      if (v instanceof Select) {
          return Foreign_Generic_Class.encode(encodeSelectField)(v.value0);
      };
      throw new Error("Failed pattern match at Inputs.Types (line 29, column 12 - line 31, column 25): " + [ v.constructor.name ]);
  });
...
(function($PS) {
  ...
  var readFormConfig = runExceptDecode(Foreign_Generic_Class.arrayDecode(Inputs_Types.decodeInputField))($foreign["_readFormConfig"]);
...
(function($PS) {
  ...
  var main = function __do() {
      var v = Form_Utils.readFormConfig();
      if (v instanceof Data_Either.Left) {
          return Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Error in Config")();
      };
      if (v instanceof Data_Either.Right) {
          return Form_Utils.writeFormConfig(v.value0)();
      };
      throw new Error("Failed pattern match at Main (line 12, column 22 - line 14, column 35): " + [ v.constructor.name ]);
  };
  exports["main"] = main;
})(PS);
},{}]},{},[1]);
